...
const Recipe = () => {
    ...
    return (
      ...
      >
        ...
        <p className="text-red-700">
          We're sorry, but there was an error loading the recipe details. Please try refreshing the
          page or go back to search for other recipes.
        </p>
        <button
          onClick={goBack}
  ...
  return (
    <div
      className="flex flex-wrap justify-center overflow-scroll relative"
      ref={mainContentRef}
      tabIndex={-1}
